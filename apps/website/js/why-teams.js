(() => {
    ...
    const teams = {
        alpha: {
            ...
            operate: [
                ['⬡', "How We're Led", 'Hands-on when needed, high trust by default. Clear goals, strong ownership. Managers coach, not micromanage.'],
                ['☆', "What We're Solving Now", 'Scaling infrastructure, reducing tech debt, improving retention, migrating from monolith to microservices.'],
                ...
                ['↗', 'Growth Here', 'Learning budget for everyone. Clear promotion paths. Prefer internal growth. Mentorship formal and informal.']
            ]
        },
        beta: {
            label: 'Team Beta',
            ...
            product: 'search',
            overview: [
                ['♙', 'Who We Are', 'Backend-heavy engineers with ML expertise. Distributed across 2 time zones with 5+ years avg experience.'],
            ...
            operate: [
                ['⬡', "How We're Led", 'Flat hierarchy. Tech lead sets direction, but everyone contributes to architecture decisions. Quarterly OKRs.'],
                ['☆', "What We're Solving Now", 'Real-time recommendation engine, reducing model latency by 40%, building feature store for cross-team use.'],
        ...
        gamma: {
            ...
            product: 'sales',
            overview: [
                ['♙', 'Who We Are', 'A product squad connecting customer insight, design, engineering, and go-to-market expertise.'],
                ['☆', "What We're Great At", 'Turning customer feedback into simple, measurable product improvements.'],
                ['♡', 'Team Culture', 'Fast feedback, respectful debate, and strong accountability across every discipline.'],
                ['◇', 'How We Work Together', 'Weekly customer sessions, focused delivery blocks, and visible decisions in shared documentation.'],
                ['⬡', 'This Team is NOT For You If...', 'You prefer working without direct customer feedback or measurable goals.', true]
            ],
            operate: [
                ['⬡', "How We're Led", 'Product and engineering share direction while specialists own the execution details.'],
                ['☆', "What We're Solving Now", 'Improving onboarding conversion and making sales workflows easier to customize.'],
                ['▣', 'A Typical Day', 'Customer research, design reviews, focused build time, and a short progress sync.'],
                ['♡', 'What We Value', 'Clarity, empathy, experimentation, and decisions backed by evidence.'],
                ['↗', 'Growth Here', 'Cross-functional mentorship and regular opportunities to own complete product outcomes.']
            ]
        },
        delta: {
            label: 'Team Delta',
            ...
            product: 'cloud',
            overview: [
                ['♙', 'Who We Are', 'Infrastructure specialists focused on dependable systems, developer experience, and security.'],
                ['☆', "What We're Great At", 'Automation, observability, incident response, and scalable cloud architecture.'],
                ['♡', 'Team Culture', 'Calm under pressure, documentation first, and continuous improvement after every incident.'],
                ['◇', 'How We Work Together', 'Rotating ownership, clear escalation paths, and protected time for preventative engineering.'],
                ['⬡', 'This Team is NOT For You If...', 'You avoid operational ownership or dislike documenting decisions.', true]
            ],
            operate: [
                ['⬡', "How We're Led", 'Leads provide priorities and context. Engineers own systems from design to production.'],
                ['☆', "What We're Solving Now", 'Reducing deployment time, improving reliability, and standardizing platform tooling.'],
                ['▣', 'A Typical Day', 'Platform work, operational reviews, pairing, and maintenance windows planned in advance.'],
                ['♡', 'What We Value', 'Reliability, transparency, thoughtful automation, and sustainable on-call practices.'],
                ['↗', 'Growth Here', 'Cloud certifications, architecture reviews, and mentorship across infrastructure domains.']
            ]
        },
        fusion: {
            label: 'Team Fusion',
            ...
            overview: [
                ...
                ['☆', "What We're Great At", 'End-to-end test automation, accessibility audits, and building quality into the dev process.'],
                ['♡', 'Team Culture', 'Supportive and patient. We mentor junior members actively. Monthly hackathons and innovation days.'],
                ['◇', 'How We Work Together', 'Fully remote across 5 time zones. Overlap hours 10am–2pm ET. Strong async documentation culture.'],
                ['⬡', 'This Team is NOT For You If...', "You cut corners on quality or see testing as someone else's job.", true]
            ],
            operate: [
                ['⬡', "How We're Led", 'Quality ownership is shared. Leads unblock the team and keep priorities visible.'],
                ['☆', "What We're Solving Now", 'Expanding automated coverage and improving accessibility across all products.'],
                ['▣', 'A Typical Day', 'Async updates, focused test development, product reviews, and cross-team quality coaching.'],
                ['♡', 'What We Value', 'Patience, precision, curiosity, and prevention instead of blame.'],
                ['↗', 'Growth Here', 'Mentoring, quality leadership projects, and time to explore new testing approaches.']
            ]
        }
    };
    ...
    const renderMembers = (memberKeys) => {
        membersContainer.innerHTML = memberKeys.map((key) => {
    ...
    const renderPoints = (points) => {
        pointsContainer.innerHTML = points.map(([icon, title, text, warning = false]) => `
    ...
    const updateActiveButtons = (team) => {
        ...
        productButtons.forEach((button) => {
            button.classList.toggle('is-active', button.dataset.product === team.product);
        });
    };
