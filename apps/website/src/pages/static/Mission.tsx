...
export default function Mission() {
  usePageMeta(
    "Mission — Bildyx",
    "Bildyx mission: eliminate friction from hiring for companies and candidates.",
  );
      ...
      <main className="mission-main">
        <section className="mission-hero" aria-labelledby="mission-title">
          <div className="mission-hero__content">
            <img
              className="mission-hero__search mission-hero__search--job"
            ...
            <div className="mission-hero__text">
              ...
              <p>
                We eliminate friction from hiring — for both sides. Build better
                teams, hire faster, spend less.
              </p>
            </div>
          ...
          <div className="mission-inner">
            <section className="mission-stats" aria-label="Mission promises">
              ...
              <article className="mission-stat">
                <span className="mission-icon">
                  <img
                    src="/images/mission-candidate.png"
                    alt=""
                    aria-hidden="true"
                  />
                </span>
            ...
            <section
              ...
              aria-labelledby="mission-work-title"
            >
              ...
              <div className="mission-card-grid">
                <article className="mission-card">
                  ...
                  <h3>Team Building</h3>
                  <p>
                    Help companies build their team. Advise them on what roles
                    they should hire — so every hire fits the team&apos;s needs
                    and growth stage.
                  </p>
                </article>
                ...
                <article className="mission-card mission-card--dark">
                  <span className="mission-card__icon mission-card__icon--dark">
                    <img
                      src="/images/mission-lightning.png"
                      alt=""
                      aria-hidden="true"
                    />
                  </span>
                ...
                <article className="mission-card">
                  ...
                  <p>
                    Make recruitment cheap for companies. No expensive agency
                    fees — just direct, efficient connections between companies
                ...
                <article className="mission-card mission-card--danger">
                  ...
                  <p>
                    Instead, Bildyx connects job seekers and companies — no
                    searching required on either side.
                  </p>
                </article>
              </div>
            </section>
            ...
            <section
              className="mission-no-search"
              aria-labelledby="mission-no-search-title"
            >
              <div className="mission-no-search__intro">
                <h2 id="mission-no-search-title">No more searching.</h2>
                <p>
                  Bildyx replaces the search entirely — for both sides of the
                  hiring equation.
                </p>
              </div>
