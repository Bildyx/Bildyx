...
export default function TestsPreferences() {
  usePageMeta(
    "Tests & Preferences — Bildyx",
    "Manage Bildyx tests and preferences.",
  );
  ...
  useEffect(() => {
    ...
    personalityService
      ...
      .then(setTests)
      .catch((err) =>
        console.error("[TestsPreferences] Error updating statuses:", err),
      );
  }, []);
      ...
      <main className="tp-page">
        <div className="tp-shell">
          <section className="tp-card tp-table-card" aria-labelledby="tp-title">
            ...
            <div
              className="tp-tests-table"
              role="table"
              aria-label="Tests and preferences list"
            >
                    ...
                    return (
                      <div className="tp-test-row" role="row" key={test.code}>
                        <span className="tp-test-name" role="cell">
                          <Link
                            to={`/tests-preferences/test?test=${test.code}`}
                            className="tp-test-name-link"
                          >
