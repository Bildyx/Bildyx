...
export default function TeamExample() {
  usePageMeta(
    "Pekamix Team Example — Bildyx",
    "Public company and team profile example on Bildyx.",
  );
      ...
      <main className="te-page">
        ...
        <div className="te-layout">
          <aside className="te-company-rail" aria-label="Company information">
            <div
              className="te-backend-slot te-company-card-slot"
          ...
          <div className="te-content">
            <section className="te-team-panel" aria-labelledby="te-team-title">
              <div className="te-team-main">
                  ...
                  {activeTeam.members.map((member) => (
                    <article className="te-member-card" key={member.name}>
                      <div className="te-member-avatar">
                        <img
                          src={`/images/${memberImages[member.name.toLowerCase()]}`}
                          alt={member.name}
                          loading="lazy"
                        />
                      </div>
                ...
                <section
                  className="te-subsection"
                  aria-labelledby="te-offices-title"
                >
                  <h3 id="te-offices-title">Our Offices</h3>
                  <div className="te-offices">
                    {offices.map((office) => (
                      <article
                        className={`te-office${office === "Seattle" ? " is-active" : ""}`}
                        key={office}
                      >
                        <div className="te-office-dot">
                          <img
                            src={`/images/${officeImages[office]}`}
                            alt={office}
                            loading="lazy"
                          />
                        </div>
              ...
              <aside className="te-team-profile" aria-live="polite">
                ...
                <div className="te-profile-points">
                  {activePoints.map((point) => (
                    <section
                      className={`te-profile-point${point.warning ? " is-warning" : ""}`}
                      key={point.title}
                    >
                      <h3>{point.title}</h3>
                      <p>{point.text}</p>
                ...
                <div
                  className="te-profile-actions"
                  aria-label="Team profile mode"
                >
                  <button
            ...
            <section
              ...
              aria-labelledby="te-portfolio-title"
            >
              <h2 id="te-portfolio-title">
                Our Product &amp; Service Portfolio
              </h2>
              <div className="te-carousel">
                <button
                  className="te-carousel-arrow te-carousel-arrow--left"
                  type="button"
                ...
                <button
                  className="te-carousel-arrow te-carousel-arrow--right"
                  type="button"
            ...
            <section
              className="te-section te-media-section"
              aria-labelledby="te-photos-title"
            >
              <span className="te-section-pill" id="te-photos-title">
                Photos
              </span>
            ...
            <section
              className="te-section te-media-section"
              aria-labelledby="te-partners-title"
            >
              <span className="te-section-pill" id="te-partners-title">
                Partners
              </span>
              <div className="te-carousel te-media-carousel">
                <button
          ...
          <aside className="te-tip-card" aria-label="Tip">
            ...
            <p>
              Job seekers want to know the team before they apply. Create a free
              team profile on Bildyx Teams and show them yours today.
            </p>
          </aside>
        </div>
      </main>
