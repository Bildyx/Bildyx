...
export default function CompanyArchives() {
  usePageMeta("Pekamix Company Archives — Bildyx", "Historical company information for Pekamix.");
      ...
      <main className="ca-archive-page">
        ...
        <div className="ca-layout">
          <aside className="ca-rail" aria-label="Company placeholders">
            <div className="ca-company-placeholder" data-card-slot="current-company" />

            <h1 className="ca-rail-title">Parent Company</h1>

            <div className="ca-company-placeholder" data-card-slot="parent-company" />
