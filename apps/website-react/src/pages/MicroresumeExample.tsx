...
export default function MicroresumeExample() {
  usePageMeta("MicroResume Example — Bildyx", "Example of a structured Bildyx MicroResume profile.");
        ...
        <article className="mre-resume" aria-labelledby="mre-name">
          <header className="mre-profile-header">
            ...
            <div className="mre-introduction">
              <img className="mre-avatar" src="/images/hanako.png" alt="Portrait of Hanako Kingswell" />
              <p>
                ...
                with international stakeholders, bridging technical and business requirements across diverse
                markets.
              </p>
            </div>
          ...
          <section className="mre-section" aria-labelledby="mre-experiences-title">
            ...
            <div className="mre-card-grid mre-card-grid--three">
              <section className="mre-card-column">
                <h3>Company</h3>
                <div className="mre-card-slot" data-card-slot="experience-company" aria-label="Company card placeholder" />
              </section>
              ...
              <section className="mre-card-column">
                <h3>Role</h3>
                <div className="mre-card-slot" data-card-slot="experience-role" aria-label="Role card placeholder" />
              </section>
            </div>

            <div className="mre-tags mre-tags--experience" aria-label="Experience skills">
          ...
          <section className="mre-section" aria-labelledby="mre-education-title">
            <h2 id="mre-education-title">Education</h2>
            <p className="mre-entry-description">
              I was top student. I was on dean list many times. I got scholarship for academic achievement. I was
              active in Asian Club, debate club, sailing and hiking.
            </p>
