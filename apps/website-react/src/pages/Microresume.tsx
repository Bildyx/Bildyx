...
export default function Microresume() {
  usePageMeta("MicroResume — Bildyx", "Turn your resume into a scannable signal system with Bildyx MicroResume.");
  const { getSmartLoginPath } = useAuthNav();
  ...
  const centerNav = (
    <nav className="mr-header-nav" aria-label="MicroResume navigation">
      <a href="#why-microresume" onClick={(e) => handleAnchorClick(e, "why-microresume")}>
        Why MicroResume
      </a>
  ...
  return (
    <>
      ...
      <main className="mr-page">
          ...
          <div className="mr-shell mr-hero__inner">
            <div className="mr-hero__copy">
              <p className="mr-kicker">
                <span aria-hidden="true">——</span> Built for the 6-second recruiter scan
              </p>
              <h1 id="mr-hero-title">
              ...
              <p className="mr-hero__lead">
                Bildyx MicroResume is a condensed, card-based professional profile designed for how recruiters
                actually work: scanning, pattern-matching, and reducing uncertainty in seconds.
              </p>
              ...
              <div className="mr-actions">
                <Link className="mr-button mr-button--primary" to={getSmartLoginPath()}>
                  Log in
                </Link>
                <Link className="mr-button mr-button--primary" to="/microresume-example">
                  See MicroResume example
                </Link>
              </div>
              <p className="mr-note">Designed to sit on top of your existing resume — not replace it.</p>
            </div>
          </div>
        </section>

        <section className="mr-blue mr-problems" id="why-microresume" aria-labelledby="mr-problems-title">
          <div className="mr-shell">
            <header className="mr-section-heading mr-section-heading--light">
              ...
              <p>
                Hiring is rapid uncertainty reduction under time pressure. Traditional resumes weren&apos;t
                <br className="mr-desktop-only" /> built for 6-second scans, missing context, or chaotic job titles.
              </p>
            </header>
            ...
            <div className="mr-problem-grid">
              <article className="mr-problem-card">
                ...
                <p>
                  You spend hours crafting your resume. Recruiters skim it in 6–7 seconds. They scan, pattern-match,
                  and look for fast signals — not nuance.
                </p>
                <ul>
              ...
              <article className="mr-problem-card">
                ...
                <p>
                  A job title alone means little without the story behind it. Unknown universities and companies
                  feel risky when context is missing.
                </p>
                <ul>
              ...
              <article className="mr-problem-card">
                ...
                <p>
                  &quot;VP&quot; at a 15-person startup. &quot;Lead&quot; with no reports. &quot;Code ninja&quot; in a
                  job ad. Titles alone don&apos;t describe real scope or impact.
                </p>
                <ul>
            ...
            <div className="mr-underlying">
              ...
              <p>
                To cope, recruiters rely on speed-based scanning, brand recognition, and title familiarity.
                <br className="mr-desktop-only" /> When resumes lack clear, standardized context, the system
                defaults to shortcuts.
              </p>
            </div>
          </div>
        </section>

        <section className="mr-solution" id="how-it-works" aria-labelledby="mr-solution-title">
          <div className="mr-shell">
            <header className="mr-section-heading">
              <h2 id="mr-solution-title">The Bildyx MicroResume solution.</h2>
              <p>
                A condensed, modular, card-based professional profile that sits on top of your existing
                <br className="mr-desktop-only" /> resume. Built to match real recruiter behavior.
              </p>
            </header>
        ...
        <section className="mr-blue mr-advantage" aria-labelledby="mr-advantage-title">
          <div className="mr-shell">
            <header className="mr-section-heading mr-section-heading--light">
              <h2 id="mr-advantage-title">The core advantage: less guessing, more clarity.</h2>
              <p>
                Traditional resumes increase uncertainty through ambiguous titles, unknown brands,
                <br className="mr-desktop-only" /> dense formatting, and hidden impact. Bildyx reduces uncertainty by
                standardizing how
            ...
            <div className="mr-advantage-grid">
              ...
              <article>
                ...
                <p>
                  The best candidate shouldn&apos;t just be the one with the most famous logo or most polished
                  formatting. They should be the one whose skills, experience, and impact actually match the role.
                </p>
              </article>
              <article>
        ...
        <section className="mr-final" aria-labelledby="mr-final-title">
          <div className="mr-shell mr-final__inner">
            ...
            <p>
              If you&apos;re tired of being overlooked because your story doesn&apos;t fit
              <br className="mr-desktop-only" /> into a 6-second skim, MicroResume is for you. Turn your
              <br className="mr-desktop-only" /> experience into a clear, scannable signal system.
            </p>
            <Link className="mr-button mr-button--primary" to={getSmartLoginPath()}>
              Log in
            </Link>
            <p className="mr-note">No spam. Just occasional progress updates and an invite when we&apos;re ready.</p>
          </div>
        </section>
      </main>
